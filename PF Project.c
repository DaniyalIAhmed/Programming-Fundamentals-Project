...
main(){
    ...
    int a;
    printf("\n                                    MENU\n=======================================================================================\n\n");
    printf("   1-[Desi Foods]  2-[Fast Food]  3-[Sea Food]  4-[Chinese Food]  5-[Print BILL!!]  6-[Search]  7-[Reviews]\n");
    printf("   enter choice: ");
    int b;
    scanf("%d",&b);
    system("cls");
...
void    chicken_tikka (void){
   ...
   void pizza_lar (void){
    ...
    scanf("%d",&c);
    x[i].tot=y[104+c].price;
	strcpy(x[i].item,"grilled fish");
	
}
    void spag_nood (void){
	int c;
	for(int j=111;j<=115;j++){
	printf(" %s",y[j].resturant);
	}
    scanf("%d",&c);
    x[i].tot=y[110+c].price;
   ...
   void wonton (void){
    ...
    scanf("%d",&c);
    x[i].tot=y[115+c].price;
	strcpy(x[i].item,"wonton");
	
}
   void  soup (void){
	int c;
	for(int j=121;j<=125;j++){
	printf(" %s",y[j].resturant);
	}
    scanf("%d",&c);
    x[i].tot=y[120+c].price;
   ...
   void chowmein (void){
    ...
    scanf("%d",&c);
    x[i].tot=y[125+c].price;
	strcpy(x[i].item,"chowmein");
	
}
    void dumplings (void){
	int c;
	for(int j=131;j<=136;j++){
	printf(" %s",y[j].resturant);
	}
    scanf("%d",&c);
    x[i].tot=y[130+c].price;
...
void review(int coder){
	...
	sleep(1);
	fprintf (rev,"\n%s",review);
	printf ("Do you want to see your review\nY for yes ");
	scanf (" %c",&see);
	if(see=='y'){
		while(!feof(rev)){
		    fgets (revfile,100,rev);
